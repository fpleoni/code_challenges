...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            the lock closses forever and you can't get the bomb. The
            code is 3 digits.
            """))
        ...
        if guess == code:
            print(dedent("""
                ...
                gas put. You grab the neutron bomb and run as fast as
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                ...
                carefully place the bomb on the bloor, pointing your
